...
if(isset($_POST['submit'])){
    ...
    var_dump("THis is author id".$author_id);
   ...
   // redirect  back (with from data ) to add-post page if there is any problems
   if(isset($_SESSION['add-post'])){
    ...
    // set is_featured of all posts to 0 if is_featured for this post 1
    if($is_featured == 1){
        $zero_all_is_featured_query = "UPDATE posts SET is_featured=0";
        $zero_all_is_featured_result = mysqli_query($connection,$zero_all_is_featured_query);
    }
    //inswrt post into database
